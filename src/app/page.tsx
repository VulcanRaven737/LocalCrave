  ...
  return (
    <>
      ...
      <div className='mt-24 flex font-poppins text-6xl subpixel-antialiased font-normal flex'>
        <Image src='images/semicylinder.svg' alt='semi'/>
        ...
        <Image src='images/rectangle1.svg' alt='rect1' className='ml-48'/>
        <Image src='images/rectangle2.svg' alt='rect2' className='ml-20'/>
        <Image src='images/rectangle3.svg' alt='rect3' className='ml-20 pl-2'/>
      </div>
    </>
  );
}
