  ...
  return (
    <>
      <nav className="p-3 bg-[#d3d3ff] rounded-b-3xl max-w-auto flex relative">
        ...
        <button className="text-[#090933] font-bold relative ml-16" onClick={() => window.location.href='/features'}>Customers</button>
        <button className="text-[#090934] absolute font-bold right-20 mt-6  rounded-xl text-blueish-100 w-16 h-8" onClick={() => window.location.href='/features'}>Signup</button>
      </nav>
